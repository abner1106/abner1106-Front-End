    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form action="{{ route('equipos.update', $equipo->id_equipo) }}" method="POST" class="card mt-4 p-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('tipo_equipo') is-invalid @enderror" id="tipo_equipo"
                            name="tipo_equipo" value="{{ old('tipo_equipo', $equipo->tipo_equipo) }}" required>
                        @error('tipo_equipo')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('num_serie') is-invalid @enderror" id="num_serie"
                            name="num_serie" value="{{ old('num_serie', $equipo->num_serie) }}" required>
                        @error('num_serie')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('modelo') is-invalid @enderror" id="modelo"
                                name="modelo" value="{{ old('modelo', $equipo->modelo) }}" required>
                            @error('modelo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('caracteristicas') is-invalid @enderror" id="caracteristicas"
                            ...
                            rows="3">{{ old('caracteristicas', $equipo->caracteristicas) }}</textarea>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('estado') is-invalid @enderror" id="estado" name="estado"
                                ...
                                <option value="Inactivo" {{ old('estado', $equipo->estado) == 'Inactivo' ? 'selected' : '' }}>
                                    Inactivo</option>
                                <option value="En mantenimiento" {{ old('estado', $equipo->estado) == 'En mantenimiento' ? 'selected' : '' }}>En mantenimiento</option>
                            </select>
                            @error('estado')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('ubicacion_id') is-invalid @enderror" id="ubicacion_id"
                                ...
                                @foreach ($ubicaciones as $ubicacion)
                                    <option value="{{ $ubicacion->id_ubicacion }}" {{ old('ubicacion_id', $equipo->ubicacion_id) == $ubicacion->id_ubicacion ? 'selected' : '' }}>
