                ...
                <form action="{{ route('mantenimientos.update', $mantenimiento->id_mantenimiento) }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('id_equipo') is-invalid @enderror" id="id_equipo" name="id_equipo"
                            ...
                            @foreach ($equipos as $equipo)
                                <option value="{{ $equipo->id_equipo }}" {{ old('id_equipo', $mantenimiento->id_equipo) == $equipo->id_equipo ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('descripcion_falla') is-invalid @enderror"
                            ...
                            required>{{ old('descripcion_falla', $mantenimiento->descripcion_falla) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('acciones_realizadas') is-invalid @enderror"
                            ...
                            required>{{ old('acciones_realizadas', $mantenimiento->acciones_realizadas) }}</textarea>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save"></i> Actualizar Mantenimiento
                        </button>
